...
describe("drawField", () => {
  ...
  it("renders daying field 1x1", () => {
    drawField(el, [[2]], onCellClick);
    expect(el.querySelectorAll(".cell").length).toBe(1);
    expect(el.querySelectorAll(".cell.daying").length).toBe(1);
  });
  it("renders field mxn", () => {
    ...
    expect(el.querySelectorAll(".cell.dead").length).toBe(5);
    expect(el.querySelectorAll(".cell.daying").length).toBe(1);
  });
